...
class SampleSortedArraysOverlapTest(TestCase):
    ...
    def test_07_same_elements(self):
        ...
        self._assert(array_1, array_2)
        self._assert(array_2, array_1)
        # Arrays are equal, elements in the array are not the same
        self._assert(array_1, array_1)
        # Each array has same elements, arrays are equal
        self._assert(array_2, array_2)
        # Each array has same elements, they differ across arrays
