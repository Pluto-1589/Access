...
class TestCars(TestCase):
    ...
    def test_get_details_student(self):
        ...
        self.assertEqual(
            ('Alice', 'alice@uzh.ch', '24-000-001'), student.get_details())

    def test_get_details_professor(self):
        professor = Professor("Dr. Dave", "dave@uzh.ch",
                              "01234567", "BIN-0.Z.00")
        self.assertEqual(('Dr. Dave', 'dave@uzh.ch', '01234567',
                         'BIN-0.Z.00'), professor.get_details())
